	...
	public class DelegationRepository : IDelegationRepository
	{
		...
		public List<Templete> GetAllTemplete()
		{
			return [
				...
				new() {Id = 8, Name= "Public", Message ="By taking all necessary official and legal measures to represent me before all state ministries, departments, bodies and institutions, as well as\r\nAll private entities, whether companies or individuals, and in particular the following ministries / the Ministry of Interior and its various departments (General Administration of Nationality and Passports), in order to request the issuance of citizenship certificates or passports to the General Administration of Immigration Affairs - in order to establish residency permits for employees, workers, and covered employees. With my sponsorship, as well as terminating their services, canceling their residency, signing employment contracts before a notary public, and having them authenticated by the Ministry of Justice and the General Traffic Department, in order to conduct a technical inspection on my vehicles, renew their books, and receive them, and before all state ministries, agencies, and institutions, including the General Administration for Public Affairs. Residency, the General Authority for the Manpower and all its administrations, the workforce restructuring program, the executive apparatus of the state, the General Authority for Disabled Affairs, the General Fire Department, the Ministry of Interior and its various administrations, including the Naturalization Administration, the General Institution for Housing Welfare, the Ministry of Social Affairs and Labor, and the Public Institution. Social Insurance, all governmental ministries and other non-governmental departments and committees, the Ministry of Social Affairs and Labor and its offices, the Ministry of Justice and its various departments, in particular the Department of Real Estate Registration and Documentation, the Ministry of Trade and Industry and its various departments (Kuwait Chamber of Commerce and Industry), the Ministry of Finance and its various departments, the Ministry of Education and its various departments, and the Authority. General Applied Education. The Ministry of Electricity and Water and its various departments, and the Ministry of Transportation and its various departments. The Ministry of Public Health and its various departments. The Ministry of Housing and its various departments - the Public Authority for Housing, the Kuwait Credit Bank, the Kuwait Municipality and its various departments, including the Expropriation Department and the Public Authority for Civil Information, in order to obtain my civil cards and all kinds of certificates and documents and replace lost ones, the Public Authority for Compensation Assessment, and the Public Authority for Agricultural Affairs and Fisheries Affairs. The General Organization for Social Insurance, the General Administration of Customs (air - sea - land), the Kuwaiti Flour Mills and Bakeries Company, and the Kuwaiti Catering Company. In order to complete the tasks entrusted to him, the agent has the right to follow up and accomplish everything necessary for that, submit, deliver and receive all identification papers and sign applications, forms, documents, identification papers and records. Everything necessary in this regard" }
		];
		}
